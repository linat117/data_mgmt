// Ethiopian Data Management Script
// Run this in browser console to clear dummy data and create realistic Ethiopian data

import { getAllClients, createClient, deleteClient } from '../services/recordService';
...
export { resetAndCreateEthiopianData, clearAllData, createEthiopianData };
